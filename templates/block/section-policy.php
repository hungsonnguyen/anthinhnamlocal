<?php
// $current_term = array_shift(array_values(get_the_terms(get_the_ID(), 'danh-muc-chinh-sach')));
...
<div class="col-sm-12 col-md-12 col-lg-3 service-left">
    <div class="service-bg-pro">
        <h3 class="service-title-pro">Danh mục chính sách</h3>
        <ul class="service-list-pro mb-0 pb-3">
            <?php
            $terms = get_terms([
                'taxonomy' => 'danh-muc-chinh-sach',
                'hide_empty' => false,
                'orderby'       => 'id',
            ]);
