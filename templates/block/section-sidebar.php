...
<div class="col-sm-12 col-md-12 col-lg-3 service-left">
    <div class="service-bg">
        <h3 class="service-title">Danh mục dịch vụ</h3>
            ...
            ?>
                ...
                if ($loop->have_posts()) : ?>
                    <?php while ($loop->have_posts()) : $loop->the_post();
                        $post_id = get_the_ID();
                    ?>
                        <li class="<?php echo ($post_id == $post_current_id) ? "active-sidebar" : ""; ?>">
    ...
    <div class="service-contact my-5">
        ...
        <div class="service-content">
            ...
            <a href="tel:+84916060241" class="text-center"> <h2  class="text-white">0916 060 241</h2></a>
            <a href="tel:+84916860416" class="text-center"> <h2  class="text-white">0916 860 416</h2></a>
        </div>
    </div>
</div>