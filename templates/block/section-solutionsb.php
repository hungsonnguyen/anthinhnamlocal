<?php
$current_term = array_shift(array_values(get_the_terms(get_the_ID(), 'danh-muc-giai-phap')));
...
<div class="col-sm-12 col-md-12 col-lg-3 service-left">
    <div class="service-bg">
        <h3 class="service-title">Danh mục giải pháp</h3>
        <ul class="service-list mb-0 pb-3">
            <?php
            $terms = get_terms([
            ...
            ?>
                <div>
                    ...
                    <li id="" class="<?php echo ($current_term_slug == $term->slug) ? "active-sidebar" : ""; ?>">
                        <a href="<?php echo get_home_url(); ?><?php echo  "/" . $term->taxonomy . "/" . $term->slug; ?>" class="nav-link a-nav-link">
                            <?php echo $term->name; ?>
                        </a>
                    </li>
