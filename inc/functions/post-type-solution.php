...
function post_type_solution()
{

	$labels = array(
		'name'                  => _x('Giải pháp', 'Post Type General Name', 'blog'),
		'singular_name'         => _x('Giải pháp', 'Post Type Singular Name', 'blog'),
		'menu_name'             => __('Giải pháp', 'blog'),
		'name_admin_bar'        => __('Giải pháp', 'blog'),
		'archives'              => __('Item Archives', 'blog'),
		'attributes'            => __('Item Attributes', 'blog'),
		'parent_item_colon'     => __('Parent Item:', 'blog'),
		'all_items'             => __('Tất cả g.pháp', 'blog'),
		'add_new_item'          => __('Thêm g.pháp', 'blog'),
		'add_new'               => __('Thêm g.pháp', 'blog'),
		'new_item'              => __('Giải pháp mới', 'blog'),
		'edit_item'             => __('Sửa Giải pháp', 'blog'),
		'update_item'           => __('Cập nhập Giải pháp', 'blog'),
		'view_item'             => __('Xem Giải pháp', 'blog'),
		'view_items'            => __('Xem Giải pháp', 'blog'),
		'search_items'          => __('Tìm kiếm Giải pháp', 'blog'),
		'not_found'             => __('Không tìm thấy Giải pháp nào', 'blog'),
		'not_found_in_trash'    => __('Không tìm thấy Giải pháp nào', 'blog'),
	...
	$args = array(
		'label'                 => __('Giải pháp', 'blog'),
		'description'           => __('Giải pháp', 'blog'),
		'labels'                => $labels,
		'supports'              => array('title', 'editor', 'thumbnail', 'excerpt'),
		'taxonomies'            => array('danh-muc-giai-phap'),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
...
add_action('init', 'post_type_solution', 0);

// Register Custom Taxonomy
function taxonomy_solution_category()
{

	$labels = array(
		'name'                       => _x('Danh mục Giải pháp', 'Taxonomy General Name', 'blog'),
		'singular_name'              => _x('Danh mục Giải pháp', 'Taxonomy Singular Name', 'blog'),
		'menu_name'                  => __('Danh mục Giải pháp', 'blog'),
	...
	register_taxonomy('danh-muc-giai-phap', array('giai-phap'), $args);
}
add_action('init', 'taxonomy_solution_category', 0);
